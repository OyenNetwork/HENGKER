...
func main() {
	...
	go func() {
				...
				fmt.Println("\u001B[31m>> \x1b[38;2;0;2555mAttack Successfully Sent To All (\u001B[31mC2\x1b[38;2;0;2555m) Servers! : (\u001B[31m\x1b[38;2;0;2555m) C2 Sent.\u001B[31m . \u001B[35m.\x1b[38;2;0;2555m") 
		...
		for {
			...
			if sent%10 == 0 {
				fmt.Printf("\r%6d %6d â•‘\t%6d â•‘\t%0d", cur, maxproc, sent, err)
			}
			switch <-ss {
			case callExitOnErr:
			...
			case targetComplete:
				sent++
				fmt.Printf("\r%-6d of max %-6d â•‘\t%7d â•‘\t%6d", cur, maxproc, sent, err)
				fmt.Println("\rðŸš€EPEP ATTACK FINISHEDðŸš€     \n\n\r")
				os.Exit(0)
			}
		}
	}()
